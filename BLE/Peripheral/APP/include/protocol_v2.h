...
typedef enum {
    ...
    V2_OP_GET_CONNECTIVITY_CONFIG = 0x55,
    V2_OP_SET_CONNECTIVITY_CONFIG = 0x56,
    V2_OP_GET_CONNECTIVITY_STATUS = 0x57,
    V2_OP_RESTART_CELLULAR = 0x58,
    V2_OP_CELLULAR_AT = 0x59,
    V2_OP_SET_DEVICE_NAME = 0x5A,
    V2_OP_RESTART_DEVICE = 0x5B,
